...
*/
function activityreport_civicrm_postInstall() {
  _activityreport_civix_civicrm_postInstall();
}
 ...
 *
function activityreport_civicrm_preProcess($formName, &$form) {
 ...
 *
function activityreport_civicrm_navigationMenu(&$menu) {
  _activityreport_civix_insert_navigation_menu($menu, NULL, array(
    'label' => ts('The Page', array('domain' => 'com.jasontdc.activityreport')),
    'name' => 'the_page',
  ...
  _activityreport_civix_navigationMenu($menu);
} // */
